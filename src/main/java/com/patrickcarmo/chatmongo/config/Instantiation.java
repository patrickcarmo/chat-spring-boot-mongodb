...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... arg0) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("20/02/2018"), "Partiu cama", "Vou ir dormir, boa noite!", alex);
		Post post2 = new Post(null, sdf.parse("21/02/2018"), "Bom dia", "Hoje eu acordei para sorrir mostrar os dentes!", alex);
